...
const MovementCard = ({ movement, onEdit, onDelete, onJoin, requestingId }) => {
  ...
  const isOwner =
    user &&
    movement.userId &&
    (user._id === movement.userId._id || user._id === movement.userId);
    ...
    <SpotlightCard className="feature-card group overflow-hidden p-0!">
      <div className="flex flex-col h-full">
        ...
        <div className="relative h-48 w-full overflow-hidden mb-6">
          ...
          <div
            className={`absolute top-4 right-4 px-2 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter ${
              status === "active"
          ...
          <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
            ...
            >
              ...
              <div>
                ...
                <p className="text-[10px] font-bold text-gray-400 lowercase tracking-wider leading-none">
                  @{userId?.username}
                </p>
              </div>
            </Link>
              ...
              {isOwner ? (
                <>
                  ...
                  <button
                    ...
                    className="flex items-center justify-center w-10 h-10 bg-red-50 text-red-600 rounded-xl hover:bg-red-600 hover:text-white transition-all duration-300"
                  >
                    <Trash2 size={16} />
                  </button>
                </>
